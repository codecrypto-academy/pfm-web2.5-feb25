...
function getBalance(url, address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, callApi(url, "eth_getBalance", [address, "latest"])];
                case 1:
                    data = _a.sent();
                    return [2 /*return*/, BigInt(data.result)]; // Retorna el balance en formato BigInt
            }
        });
    });
}
...
function sendTransaction(url, from, to, amount, privateKey) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, callApi(url, "eth_sendTransaction", [
                        {
                            from: from,
                            to: to,
                            value: amount,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    json = _a.sent();
                    return [2 /*return*/, json]; // Retorna la respuesta de la API en formato JSON
            }
        });
    });
}
